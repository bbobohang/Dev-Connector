...
// @descr delete profiles, usr and profile
// @acess private
...
router.put(
	...
	async (req, res) => {
		...
		//Create an object for the experience
		const newExp = {
			title,
			company,
			location,
...
router.put(
	...
	async (req, res) => {
		...
		const { school, fieldofstudy, degree, from, to, current, description } =
			req.body;

		//Create an object for the education
		const newEdu = {
			school,
			fieldofstudy,
			degree,
